import { l as setContext, g as getContext, c as create_ssr_component, f as compute_rest_props, s as subscribe, h as spread, k as escape_object, a as add_attribute, v as validate_component, j as escape_attribute_value } from "./ssr.js";
import { o as omit, m as makeElement, d as disabledAttr, e as executeCallbacks, a as addMeltEventListener, s as styleToString, b as isHTMLElement, f as createElHelpers, k as kbd, g as getElementByMeltId, c as cn, i as is_void } from "./gsapConfig.js";
import "clsx";
import "dequal";
import { t as toWritableStores, g as generateIds, o as overridable, a as tick, b as generateId, r as removeUndefined, c as createBitAttrs, d as getOptionUpdater, e as createDispatcher, I as Icon, s as slide } from "./Icon.js";
...
const GuyTwo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<svg width="537" height="451" viewBox="0 0 537 451" fill="none" xmlns="http://www.w3.org/2000/svg"><g clip-path="url(#clip0_22_79)"><path d="M198.653 120.039C221.784 103.393 253.642 109.861 276.178 127.499C283.532 133.333 290.286 140.055 296.319 147.541C299.837 151.844 303.173 156.362 306.363 161.035C307.149 162.181 307.931 163.339 308.698 164.509C309.223 165.299 309.744 166.096 310.26 166.897C316.73 176.926 322.661 187.477 328.468 197.932C342.964 224.031 357.837 250.906 379.924 269.23C384.474 273.004 390.823 276.403 395.485 272.799C399.53 269.669 399.704 263.088 398.783 257.695C395.36 237.713 383.012 221.155 369.895 207.019C356.778 192.884 342.257 179.925 332.345 162.844C322.434 145.764 317.906 122.961 326.587 105.072C334.069 89.6568 350.166 81.0098 365.879 80.607C381.59 80.2081 396.855 87.0189 410.148 96.3709C423.439 105.727 435.127 117.598 447.324 128.652C454.677 135.32 464.943 141.937 472.956 136.291C479.725 131.52 480.253 120.065 476.219 112.353C472.185 104.64 464.986 99.7932 458.084 95.2731C436.655 81.2342 415.225 67.1966 393.796 53.1603C387.221 48.8577 380.503 44.4175 375.65 37.8566C370.796 31.2995 368.101 22.0837 370.777 14.1212C373.416 6.27439 380.789 1.29174 388.248 0.251895C395.702 -0.785549 403.22 1.51935 410.193 4.64143C436.323 16.3442 497.85 92.9054 514.248 105.995C524.787 114.402 535.857 125.045 536.923 139.445C538.25 157.372 522.256 172.249 506.201 173.988C490.148 175.732 474.59 167.948 460.247 159.718C445.903 151.489 431.265 142.415 415.166 141.273C399.067 140.131 381.004 149.728 377.188 167.206C373.869 182.414 382.306 198.107 393.296 207.838C401.899 215.457 411.995 220.531 421.747 226.236C424.455 227.816 427.135 229.449 429.748 231.195C436.439 235.674 442.694 240.917 448.411 246.841C454.412 253.05 459.799 259.959 464.479 267.449C468.214 273.418 471.473 279.739 474.218 286.342C474.636 287.351 475.043 288.373 475.437 289.41C475.81 290.401 476.171 291.405 476.514 292.419C480.99 305.568 482.734 320.304 477.016 332.579C471.312 344.821 458.958 352.07 446.621 353.075C439.486 353.55 432.335 352.497 425.554 349.972C420.568 348.165 415.741 345.852 411.134 343.06C389.776 330.275 372.867 310.003 357.424 289.162C341.986 268.323 327.448 246.38 309.119 228.69C290.791 210.996 267.824 197.619 243.582 197.822C219.341 198.022 194.352 214.493 187.467 240.412C177.432 221.128 170.646 199.145 171.542 176.874C172.438 154.602 181.856 132.13 198.653 120.039Z" fill="#3F3D56"></path><path d="M292.699 192.092C294.17 192.092 295.363 190.762 295.363 189.122C295.363 187.482 294.17 186.152 292.699 186.152C291.229 186.152 290.036 187.482 290.036 189.122C290.036 190.762 291.229 192.092 292.699 192.092Z" fill="#7400B8"></path><path d="M192.332 196.339C194.606 196.339 196.45 194.283 196.45 191.747C196.45 189.211 194.606 187.155 192.332 187.155C190.058 187.155 188.215 189.211 188.215 191.747C188.215 194.283 190.058 196.339 192.332 196.339Z" fill="#FF66B3"></path><path d="M489.944 155.708C490.784 155.708 491.465 154.949 491.465 154.012C491.465 153.075 490.784 152.315 489.944 152.315C489.104 152.315 488.422 153.075 488.422 154.012C488.422 154.949 489.104 155.708 489.944 155.708Z" fill="#FF66B3"></path><path d="M459.16 64.5217C460.001 64.5217 460.682 63.7621 460.682 62.8251C460.682 61.888 460.001 61.1284 459.16 61.1284C458.32 61.1284 457.639 61.888 457.639 62.8251C457.639 63.7621 458.32 64.5217 459.16 64.5217Z" fill="#FF66B3"></path><path d="M420.014 230.188C420.445 228.797 421.027 227.47 421.747 226.236C424.455 227.816 427.135 229.449 429.748 231.195C436.439 235.674 442.694 240.917 448.411 246.841C446.11 250.328 442.764 252.78 438.98 253.751C435.197 254.721 431.227 254.147 427.791 252.132C424.355 250.117 421.68 246.794 420.253 242.768C418.826 238.742 418.741 234.278 420.014 230.188Z" fill="#FF66B3"></path><path d="M225.983 174.971C226.842 174.971 227.538 174.195 227.538 173.236C227.538 172.278 226.842 171.501 225.983 171.501C225.123 171.501 224.427 172.278 224.427 173.236C224.427 174.195 225.123 174.971 225.983 174.971Z" fill="#F0F0F0"></path><path d="M416.617 46.5886C417.476 46.5886 418.173 45.8117 418.173 44.8534C418.173 43.895 417.476 43.1182 416.617 43.1182C415.758 43.1182 415.061 43.895 415.061 44.8534C415.061 45.8117 415.758 46.5886 416.617 46.5886Z" fill="#F0F0F0"></path><path d="M402.607 15.6799C403.467 15.6799 404.163 14.903 404.163 13.9447C404.163 12.9864 403.467 12.2095 402.607 12.2095C401.748 12.2095 401.051 12.9864 401.051 13.9447C401.051 14.903 401.748 15.6799 402.607 15.6799Z" fill="#F0F0F0"></path><path d="M512.785 130.894C513.645 130.894 514.341 130.117 514.341 129.158C514.341 128.2 513.645 127.423 512.785 127.423C511.926 127.423 511.229 128.2 511.229 129.158C511.229 130.117 511.926 130.894 512.785 130.894Z" fill="#F0F0F0"></path><path d="M431.052 133.386C431.912 133.386 432.608 132.61 432.608 131.651C432.608 130.693 431.912 129.916 431.052 129.916C430.193 129.916 429.496 130.693 429.496 131.651C429.496 132.61 430.193 133.386 431.052 133.386Z" fill="#F0F0F0"></path><path d="M387.68 298.893C388.539 298.893 389.236 298.116 389.236 297.158C389.236 296.2 388.539 295.423 387.68 295.423C386.821 295.423 386.124 296.2 386.124 297.158C386.124 298.116 386.821 298.893 387.68 298.893Z" fill="#F0F0F0"></path><path d="M338.785 136.122C339.644 136.122 340.341 135.345 340.341 134.387C340.341 133.428 339.644 132.652 338.785 132.652C337.926 132.652 337.229 133.428 337.229 134.387C337.229 135.345 337.926 136.122 338.785 136.122Z" fill="#F0F0F0"></path><path d="M336.601 103.311C337.46 103.311 338.157 102.534 338.157 101.575C338.157 100.617 337.46 99.8401 336.601 99.8401C335.741 99.8401 335.045 100.617 335.045 101.575C335.045 102.534 335.741 103.311 336.601 103.311Z" fill="#F0F0F0"></path><path d="M421.898 304.538C424.463 296.257 428.757 288.775 434.425 282.708C435.173 281.909 435.943 281.137 436.734 280.392C444.57 273 454.258 268.481 464.479 267.449C468.214 273.418 471.473 279.739 474.218 286.342C474.636 287.351 475.043 288.373 475.437 289.41C475.81 290.401 476.171 291.405 476.514 292.419C480.991 305.568 482.734 320.304 477.016 332.579C471.312 344.821 458.958 352.07 446.621 353.075C439.486 353.55 432.335 352.497 425.555 349.972C421.882 342.707 419.723 334.613 419.239 326.291C419.177 325.244 419.147 324.195 419.138 323.142C419.098 316.811 420.032 310.518 421.898 304.538Z" fill="#7400B8"></path><path d="M401.304 293.544C403.803 285.513 413.153 280.786 427.636 280.227C430.534 280.113 433.721 281.457 436.734 280.392C451.351 275.223 464.612 278.601 475.437 289.41C475.81 290.401 476.172 291.405 476.514 292.419C476.37 292.359 476.225 292.302 476.08 292.246C461.453 286.585 446.933 283.281 434.425 282.708C432.114 282.604 429.357 281.113 427.711 282.675C414.489 295.223 405.546 289.966 403.378 294.347C400.212 300.746 405.83 310.717 415.996 320.319C417.001 321.27 418.049 322.211 419.138 323.142C419.147 324.195 419.177 325.244 419.239 326.291C417.599 324.939 416.045 323.572 414.577 322.189C403.519 311.745 398.806 301.571 401.304 293.544Z" fill="#E4E4E4"></path><path d="M456.087 350.423C456.946 350.423 457.643 349.646 457.643 348.688C457.643 347.73 456.946 346.953 456.087 346.953C455.228 346.953 454.531 347.73 454.531 348.688C454.531 349.646 455.228 350.423 456.087 350.423Z" fill="#F0F0F0"></path><path d="M428.558 328.105C429.417 328.105 430.114 327.328 430.114 326.37C430.114 325.412 429.417 324.635 428.558 324.635C427.699 324.635 427.002 325.412 427.002 326.37C427.002 327.328 427.699 328.105 428.558 328.105Z" fill="#F0F0F0"></path><path d="M449.62 332.821C457.977 332.821 464.751 325.266 464.751 315.947C464.751 306.628 457.977 299.073 449.62 299.073C441.263 299.073 434.489 306.628 434.489 315.947C434.489 325.266 441.263 332.821 449.62 332.821Z" fill="#F0F0F0"></path><path opacity="0.3" d="M211.888 129.403C215.425 129.589 222.741 131.547 230.668 134.08C238.591 136.615 247.184 139.708 255.668 142.767C270.52 148.117 285.371 153.466 300.221 158.813C302.263 159.547 304.31 160.288 306.363 161.035C307.149 162.181 307.931 163.339 308.698 164.509C306.894 163.797 305.082 163.109 303.276 162.453C295.558 159.657 288.862 157.812 281.372 155.268C269.846 151.355 257.686 146.217 245.892 141.432C234.1 136.644 220.57 131.489 211.888 129.403Z" fill="#F0F0F0"></path><path opacity="0.3" d="M475.956 95.4338L509.36 157.275L477.84 94.2038C477.804 94.0036 477.725 93.8159 477.61 93.6565C477.495 93.4971 477.348 93.3705 477.18 93.2872C477.013 93.2039 476.83 93.1663 476.647 93.1775C476.464 93.1887 476.286 93.2484 476.128 93.3517C475.97 93.4549 475.836 93.5988 475.738 93.7713C475.639 93.9438 475.579 94.1399 475.562 94.3435C475.546 94.547 475.572 94.7521 475.641 94.9417C475.709 95.1314 475.817 95.3 475.956 95.4338Z" fill="#F0F0F0"></path><path d="M459.664 277.94C460.523 277.94 461.22 277.163 461.22 276.205C461.22 275.246 460.523 274.469 459.664 274.469C458.805 274.469 458.108 275.246 458.108 276.205C458.108 277.163 458.805 277.94 459.664 277.94Z" fill="#F0F0F0"></path><path d="M186.746 272.212C192.255 272.212 196.721 267.232 196.721 261.088C196.721 254.945 192.255 249.964 186.746 249.964C181.236 249.964 176.77 254.945 176.77 261.088C176.77 267.232 181.236 272.212 186.746 272.212Z" fill="#7400B8"></path><path d="M180.836 254.981C179.83 254.674 178.897 254.125 178.102 253.372C177.307 252.62 176.67 251.682 176.235 250.625C175.801 249.568 175.579 248.418 175.586 247.255C175.593 246.092 175.829 244.945 176.276 243.895L158.214 224.064L171.096 220.999L186.273 240.301C187.805 241.256 188.97 242.805 189.547 244.654C190.123 246.503 190.072 248.524 189.401 250.334C188.731 252.143 187.489 253.616 185.911 254.472C184.332 255.329 182.526 255.51 180.836 254.981Z" fill="#A0616A"></path><path d="M94.475 100.65L104.548 108.054L116.339 111.134C116.339 111.134 125.69 185.665 130.285 190.135C134.88 194.606 131.008 195.03 132.253 201.196C133.499 207.363 136.38 219.978 136.38 219.978C108.39 239.327 83.3837 241.69 62.0492 223.159C61.7162 221.938 61.7673 220.626 62.1943 219.442C62.6212 218.257 63.3983 217.271 64.3967 216.647C68.0039 214.148 60.1796 204.358 63.1326 202.397C66.0856 200.437 60.8674 185.772 60.8674 185.772L61.778 154.277L59.2429 149.447L62.8141 118.438L72.0202 113.875L75.1723 103.456L94.475 100.65Z" fill="#7400B8"></path><path d="M98.8398 103.265L115.449 109.433C115.449 109.433 133.822 107.269 134.567 137.77C135.311 168.271 131.887 184.639 131.887 184.639C131.887 184.639 170.106 270.349 128.706 245.035L116.608 191.91L104.139 108.479L98.8398 103.265Z" fill="#2F2E41"></path><path d="M115.497 170.698L124.112 169.371C124.112 169.371 124.944 183.856 129.065 186.051C133.186 188.247 131.797 188.608 132.283 190.932C132.769 193.256 128.618 199.695 131.882 201.296C135.147 202.897 163.678 243.012 163.678 243.012L180.511 225.63C179.354 222.134 173.787 224.979 173.438 221.273C172.999 215.67 164.188 200.363 162.312 198.401C160.437 196.438 161.178 192.978 160.207 188.331C159.235 183.683 159.909 187.993 158.29 180.246C156.67 172.5 134.718 133.029 133.955 125.877C133.192 118.725 124.255 114.515 124.255 114.515L117.309 116.321L115.497 170.698Z" fill="#2F2E41"></path><path d="M42.7565 428.278L52.8962 431.247L67.9917 389.044L53.0265 384.662L42.7565 428.278Z" fill="#A0616A"></path><path d="M39.6215 439.969L70.8024 449.1L70.906 448.66C71.7511 445.071 71.2831 441.254 69.6049 438.049C67.9267 434.845 65.1757 432.515 61.957 431.572L61.9563 431.572L57.3956 425.085L45.6339 426.792L42.912 425.995L39.6215 439.969Z" fill="#2F2E41"></path><path d="M94.7369 436.737L105.219 436.737L110.207 391.641L94.7344 391.643L94.7369 436.737Z" fill="#A0616A"></path><path d="M94.3672 448.933L126.605 448.932V448.477C126.605 444.766 125.283 441.207 122.93 438.583C120.577 435.959 117.385 434.484 114.057 434.484H114.057L108.168 429.502L97.1809 434.485L94.3667 434.485L94.3672 448.933Z" fill="#2F2E41"></path><path d="M68.5158 220.942C65.9833 224.472 67.2496 236.475 67.2496 236.475C67.2496 236.475 62.8178 275.307 64.7171 278.837C66.6164 282.367 63.4509 285.191 61.5516 290.133C59.6522 295.076 57.7529 307.078 57.7529 307.078C46.99 316.963 47.6232 362.149 47.6232 362.149L43.8245 402.393C45.0907 406.629 62.8178 407.335 65.3503 406.629C67.8827 405.923 92.574 306.372 92.574 306.372C92.574 306.372 91.3077 402.393 91.3077 406.629C91.3077 410.866 108.402 408.748 112.2 408.748C115.999 408.748 140.057 235.769 140.057 235.769V225.884L136.892 220.942C136.892 220.942 71.0482 217.412 68.5158 220.942Z" fill="#2F2E41"></path><path d="M74.5255 105.35L58.978 116.397L51.458 123.427L61.4331 194.343C61.4331 194.343 46.2779 258.805 70.1614 254.831C94.0449 250.857 92.7058 192.926 92.7058 192.926L74.5255 105.35Z" fill="#2F2E41"></path><path d="M95.329 206.09C94.4318 206.683 93.4291 207.049 92.3913 207.163C91.3536 207.276 90.3061 207.135 89.3227 206.748C88.3394 206.361 87.4439 205.739 86.6996 204.924C85.9553 204.11 85.3801 203.124 85.0146 202.035L59.6755 202.717L66.659 190.263L89.6508 191.524C91.3321 190.961 93.1403 191.105 94.7328 191.929C96.3253 192.753 97.5915 194.199 98.2915 195.995C98.9914 197.79 99.0764 199.81 98.5304 201.67C97.9844 203.531 96.8453 205.104 95.329 206.09Z" fill="#A0616A"></path><path d="M82.6873 95.7606C93.7464 95.7606 102.712 85.7627 102.712 73.4297C102.712 61.0967 93.7464 51.0989 82.6873 51.0989C71.6281 51.0989 62.663 61.0967 62.663 73.4297C62.663 85.7627 71.6281 95.7606 82.6873 95.7606Z" fill="#A0616A"></path><path d="M59.9741 58.7567C62.2226 54.8775 66.4421 52.292 70.5326 53.0185C70.9133 50.1074 72.0029 47.3685 73.6828 45.1001C75.3627 42.8317 77.5684 41.1208 80.0599 40.1536C82.5513 39.1864 85.233 39 87.8128 39.6147C90.3927 40.2294 92.7719 41.6217 94.6913 43.6399C95.3226 43.1443 96.0578 42.8388 96.826 42.7531C97.5941 42.6674 98.3691 42.8043 99.0759 43.1506C100.484 43.8644 101.709 44.9608 102.638 46.3392C104.985 49.6035 106.495 53.5164 107.006 57.6615C107.517 61.8065 107.011 66.0287 105.541 69.8784C106.041 67.8517 104.22 65.945 102.38 65.4902C100.54 65.0354 98.6094 65.4657 96.7433 65.1695C94.3516 64.79 92.2017 63.2427 89.8062 62.8945C87.793 62.6019 85.7684 63.1775 83.8052 63.7545C81.842 64.3315 79.8226 64.9198 77.8066 64.6528C75.7903 64.3859 73.1933 72.9066 73.2282 78.9081C73.2348 80.0454 73.0247 81.5056 72.028 81.7469C70.8006 82.0441 70.0894 80.155 68.9212 79.6402C68.3827 79.4681 67.8055 79.5359 67.3109 79.8291C66.8164 80.1224 66.4433 80.6183 66.2702 81.2123C66.123 81.8162 66.1072 82.4506 66.2242 83.0627C66.3412 83.6747 66.5876 84.2468 66.9429 84.7312C67.661 85.6915 68.5135 86.5162 69.4674 87.1734L68.9863 87.6196C68.186 88.7987 66.5258 88.8498 65.3722 88.1203C64.2692 87.2872 63.3758 86.1529 62.7774 84.8255C60.6432 80.8669 58.7712 76.6491 58.018 72.1071C57.2648 67.5651 57.7258 62.636 59.9741 58.7567Z" fill="#2F2E41"></path><path d="M67.0441 125.513L58.0459 116.913C58.0459 116.913 47.5395 120.569 45.7581 128.255C31.7359 148.25 24.1843 171.602 22.1561 197.82C40.4627 205.53 62.8789 208.266 86.9944 208.944L82.0068 188.086L47.7173 181.133L67.0441 125.513Z" fill="#2F2E41"></path><path d="M35.1619 439.102L30.3552 430.488L29.395 435.41C29.2267 436.273 29.0584 437.149 28.9025 438.018C27.5372 436.717 26.0846 435.515 24.6632 434.361C20.2991 430.829 15.937 427.292 11.577 423.751L12.9423 432.581C13.784 438.018 14.6631 443.566 16.7453 448.537C16.9761 449.1 17.2254 449.656 17.4936 450.199H37.7805C37.9437 449.695 38.0566 449.173 38.1172 448.641C38.1222 448.607 38.1243 448.572 38.1232 448.537C38.4414 445.165 36.7704 441.988 35.1619 439.102Z" fill="#F2F2F2"></path><path d="M214.446 429.206L223.54 412.909L225.356 422.222C225.675 423.853 225.993 425.51 226.288 427.154C228.871 424.694 231.619 422.419 234.308 420.235C242.564 413.553 250.817 406.863 259.065 400.164L256.482 416.868C254.89 427.154 253.227 437.65 249.287 447.055C248.851 448.12 248.379 449.173 247.872 450.199H209.492C209.183 449.245 208.97 448.257 208.855 447.252C208.845 447.187 208.842 447.121 208.844 447.055C208.242 440.675 211.403 434.664 214.446 429.206Z" fill="#F2F2F2"></path><path d="M207.312 450.546H165.556C163.653 450.544 161.829 449.7 160.483 448.199C159.138 446.699 158.381 444.665 158.379 442.543V279.173C158.381 277.051 159.138 275.017 160.483 273.516C161.829 272.016 163.653 271.172 165.556 271.169H207.312C209.215 271.172 211.039 272.016 212.384 273.516C213.73 275.017 214.487 277.051 214.489 279.173V442.543C214.487 444.665 213.73 446.699 212.384 448.199C211.039 449.7 209.215 450.544 207.312 450.546Z" fill="#F2F2F2"></path><path d="M197.452 275.341H176.039C175.324 275.34 174.638 275.023 174.132 274.459C173.627 273.895 173.342 273.13 173.341 272.333V263.749C173.342 262.952 173.627 262.187 174.132 261.623C174.638 261.059 175.324 260.742 176.039 260.741H197.452C198.167 260.742 198.853 261.059 199.359 261.623C199.864 262.187 200.149 262.952 200.15 263.749V272.333C200.149 273.13 199.864 273.895 199.359 274.459C198.853 275.023 198.167 275.34 197.452 275.341Z" fill="#3F3D56"></path><path d="M258.693 450.786L0.742316 451C0.545811 450.999 0.357554 450.912 0.218805 450.757C0.0800559 450.601 0.00213623 450.391 0.00213623 450.172C0.00213623 449.953 0.0800559 449.743 0.218805 449.588C0.357554 449.432 0.545811 449.345 0.742316 449.344L258.693 449.131C258.889 449.131 259.077 449.219 259.216 449.374C259.355 449.529 259.433 449.739 259.433 449.958C259.433 450.178 259.355 450.388 259.216 450.543C259.077 450.698 258.889 450.786 258.693 450.786Z" fill="#CACACA"></path></g><defs><clipPath id="clip0_22_79"><rect width="537" height="451" fill="white"></rect></clipPath></defs></svg>`;
});
  ...
  return `${validate_component(Root, "Accordion.Root").$$render($$result, {}, {}, {
    default: () => {
      return `${validate_component(Accordion_item, "Accordion.Item").$$render(
        $$result,
        {
          class: "px-5 border-2 border-black rounded-md shadow-xl",
          value: "item-1"
        },
        {},
        {
        ...
        $$result,
        {
          class: "px-5 my-2 border-2 border-black rounded-md shadow-xl",
          value: "item-2"
        },
        {},
        {
          default: () => {
            return `${validate_component(Accordion_trigger, "Accordion.Trigger").$$render($$result, { class: "border-none" }, {}, {
              default: () => {
                return `What is the cost of a custom website?`;
              }
            })} ${validate_component(Accordion_content, "Accordion.Content").$$render($$result, {}, {}, {
              default: () => {
                return `The cost varies based on the complexity and features of the website. Contact us for a
			personalized quote.`;
              }
            })}`;
          }
        ...
        {},
        {
          default: () => {
            return `${validate_component(Accordion_trigger, "Accordion.Trigger").$$render($$result, { class: "border-none" }, {}, {
              default: () => {
                return `Do you offer payment plans?`;
              }
            })} ${validate_component(Accordion_content, "Accordion.Content").$$render($$result, {}, {}, {
              default: () => {
                return `Yes, we offer flexible payment plans. Only a percentage of the total cost is needed upfront,
			and the rest can be paid in installments.`;
              }
            })}`;
          }
        }
        ...
        {},
        {
          default: () => {
            return `${validate_component(Accordion_trigger, "Accordion.Trigger").$$render($$result, { class: "border-none" }, {}, {
              default: () => {
                return `How long does it take to build a custom website?`;
              }
            })} ${validate_component(Accordion_content, "Accordion.Content").$$render($$result, {}, {}, {
              default: () => {
                return `Timelines can vary depending on the project scope. Typically, a custom website can take
			anywhere from 4 to 12 weeks from start to finish.`;
              }
            })}`;
          }
        }
        ...
        {},
        {
          default: () => {
            return `${validate_component(Accordion_trigger, "Accordion.Trigger").$$render($$result, { class: "border-none" }, {}, {
              default: () => {
                return `Will my website be mobile-friendly?`;
              }
            })} ${validate_component(Accordion_content, "Accordion.Content").$$render($$result, {}, {}, {
              default: () => {
                return `Yes, all our websites are designed to be fully responsive and mobile-friendly, ensuring a
        ...
        {},
        {
          default: () => {
            return `${validate_component(Accordion_trigger, "Accordion.Trigger").$$render($$result, { class: "border-none" }, {}, {
              default: () => {
                return `Do you provide ongoing support?`;
              }
            })} ${validate_component(Accordion_content, "Accordion.Content").$$render($$result, {}, {}, {
              default: () => {
                return `Yes, we offer ongoing support and maintenance packages to keep your website running smoothly
			and up to date.`;
              }
            })}`;
          }
        ...
        {},
        {
          default: () => {
            return `${validate_component(Accordion_trigger, "Accordion.Trigger").$$render($$result, { class: "border-none" }, {}, {
              default: () => {
                return `Can I update my website content myself?`;
              }
            })} ${validate_component(Accordion_content, "Accordion.Content").$$render($$result, {}, {}, {
              default: () => {
                return `Absolutely! Our websites come with easy-to-use content management systems that allow you to
			update major content areas like blog posts and services. However, to ensure optimal SEO and
			design consistency, the main content of the pages will be managed by our team.`;
              }
            })}`;
          }
        }
